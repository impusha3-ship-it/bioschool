 ...
 *
 * Домашних счётчиков здесь нет: таблица почёта считается по сданным работам
 * (`js/homework/pochyot.js`), где лежат и процент, и балл учителя, — прогресс
 * в браузере ни того ни другого толком не знает.
 */
